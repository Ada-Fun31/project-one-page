        ...
        if (result_dog) {
            ...
            fetch(img_1_url)
                ...
                .then(data => {
                    ...
                    image_array_dog.push(img); // array of image numbers
...
function draw() {
    ...
    //  if the clear button is not clicked, then draw all 3
    //  else, clean the background
...
function mouseClicked() {
    ...
    for (let add_Elements of image_array_dog) {
        if (mouseX < (width / 3 - 50) && mouseY < height) {
            // let img = new Image_create_dog(mouseX, mouseY, 100, 100); // create image
            // image_array_dog.push(img);
            // console.log(image_array_dog);// array of image numbers
